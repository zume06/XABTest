...
for set in range(1, len(dict_test1) + 1):
    ...
    shutil.rmtree("{}/{}_X".format(dir, inst))
    shutil.rmtree("{}/{}_A".format(dir, inst))
    shutil.rmtree("{}/{}_B".format(dir, inst))
    os.remove("{}/{}_X.list".format(dir, inst))
    os.remove("{}/{}_A.list".format(dir, inst))
    os.remove("{}/{}_B.list".format(dir, inst))
