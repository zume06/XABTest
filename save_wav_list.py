...
for set in range(len(dict_test1)):
    ...
    for i in range(len(dict_test1[str(set)])):
        for inst in ["drums", "bass", "piano", "guitar", "residuals"]:
            ...
            while sound == False:
                ...
                if Pow > thres:
                    sound = True
            os.makedirs("./wav/set{}/{}_X".format(set, inst), exist_ok=True)
            os.makedirs("./wav/set{}/{}_A".format(set, inst), exist_ok=True)
            os.makedirs("./wav/set{}/{}_B".format(set, inst), exist_ok=True)
